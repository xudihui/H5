...
const Filter = ({
  ...
  return (
    <div>
      <Row gutter={24}>
        <Col {...ColProps} >
          <FilterItem label="角色代码">
            {getFieldDecorator('code', { initialValue: name })(<Input placeholder="请输入关键字"  />)}
          </FilterItem>
        </Col>
        <Col {...ColProps} >
          <FilterItem label="中文名称">
            {getFieldDecorator('label', { initialValue: name })(<Input placeholder="请输入关键字"  />)}
          </FilterItem>
        </Col>
        <Col {...ColProps} >
        ...
        <Col {...TwoColProps} >
          <div >
            <ButtonGroup>
              ...
              <Button  type="ghost" size="large" icon="user" onClick={onRoleUser}>角色人员</Button>
